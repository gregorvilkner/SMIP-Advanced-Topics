...
- `02 API Tools.php` — the descriptor catalog (`apiDemoTools[]`) plus the `apiDemoMethods` escape hatch (see below). Single source of truth for what shows up on the doc page.
